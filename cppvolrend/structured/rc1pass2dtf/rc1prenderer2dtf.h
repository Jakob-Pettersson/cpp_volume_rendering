...
**/
#ifndef SINGLE_PASS_VOLUME_RENDERING_RAY_CASTING_2DTF_H
#define SINGLE_PASS_VOLUME_RENDERING_RAY_CASTING_2DTF_H
...
class RayCasting1Pass2DTF : public BaseVolumeRenderer
{
public:
  RayCasting1Pass2DTF ();
  virtual ~RayCasting1Pass2DTF ();

  //////////////////////////////////////////
  // Virtual base functions
  virtual const char* GetName () { return "1-Pass - Ray Casting 2D Tranfer Function"; }
  virtual const char* GetAbbreviationName () { return "s_1rc_2dtf"; }
...
private:
  ...
  gl::Texture2D* m_glsl_2d_transfer_function; // Added by Jakob
